...
class Activities4Moderate extends StatefulWidget {
  const Activities4Moderate({Key? key}) : super(key: key);

  @override
  State<Activities4Moderate> createState() => _Activities4ModerateState();
}

class _Activities4ModerateState extends State<Activities4Moderate> {
        ...
        body: Center(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      'Consider visiting a counsellor, psychiatrist or a therapist near you \n',
                    ...
                    Text(
                      ' It will help you receive health care to prevent the symptoms from proceeding in severity. Always consider health as a priority. \n\n These recommended activities can as well help you in a mean time',
                      style: GoogleFonts.balsamiqSans(
                          fontSize: 16,
                          color: Colors.black87),
                    ),
